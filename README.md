...
Legal information retrieval is different  ordinary keyword searccuments contain citations, references, formal language, repeated terminology, and context-dependent relevance. A useful retrievastem must not only words, but also understandegal references, document structure, and citation patterns influence relev
